...
#np.set_printoptions(suppress=True) # 设置 NumPy 显示选项，使得在控制台中输出浮点数时不使用科学计数法
...
def clean_string(my_string): # 对输入字符串进行文本预处理
